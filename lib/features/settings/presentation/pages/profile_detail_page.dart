              ...
              child: Column(
                children: [
                          ...
                          child: profile?.photoUrl == null || profile!.photoUrl!.isEmpty
                              ? Text(
                                  ...
                                  style: const TextStyle(
                                      fontSize: 40, color: AppColors.main, fontWeight: FontWeight.bold),
                                )
                              : null,
                        ),
                        if (isEditing)
                  ...
                  if (isEditing) ...[
                    ...
                    _buildInfoCard("Display Name", profile?.displayName ?? "Guest"),
                    const SizedBox(height: 15),
                    _buildInfoCard("Email Address", profile?.email ?? "Not logged in"),
                    const SizedBox(height: 15),
